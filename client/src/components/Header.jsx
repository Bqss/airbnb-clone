...
export default function Header() {
  ...
  return (
    <div className="fixed inset-x-0 ">
      <header className="py-4 flex justify-between w-full max-w-7xl mx-auto items-center border-y-[1px] border-slate-200 -mt-4 bg-white">
        ...
        <div className="space-x-3 flex items-center text-sm">
          <Button className={"rounded-full"}>Jadikan Rumah Anda AirBnb</Button>
          <Dropdown>
            <Dropdown.Button
              className={
